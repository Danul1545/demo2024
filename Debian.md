...
Измерить прпускную способность сети межну двумя узлами HQ-R - ISP по средствам утилиты `iperf3`.

#### Установим утилиту на устройства (HQ-SRV и BR-SRV), командой:
```
apt-install iperf3
```

#### На компьютере выступающем в роли сервера (BR-SRV) нужно прописать команду:
```
iperf3 -s
```

Если нужно будет поменять порт следует написать
```
iperf3 -s -p (новый порт)
```

#### На HQ-SRV нужно написать Ip-адрес принимающего сервера и его порт
```
...
![изображение](https://github.com/Danul1545/demo2024/assets/148867600/c9ee410c-288c-4d5d-b44c-75063a86c795)

#### Результат на HQ-SRV

![изображение](https://github.com/Danul1545/demo2024/assets/148867600/e5bfd6bc-bccb-4be7-9a1a-abdaffae4a1c)
